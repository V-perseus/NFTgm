...
import { nftgm_dai } from "./AllBonds";
...
export async function getMarketPrice({ networkID, provider }: IBaseAsyncThunk) {
  const nftgm_dai_address = nftgm_dai.getAddressForReserve(networkID);
  const pairContract = new ethers.Contract(nftgm_dai_address, PairContract, provider);
